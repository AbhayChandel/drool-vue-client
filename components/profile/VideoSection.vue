...
<script>
import VideoThumbnailCard from "@/components/profile/VideoThumbnailCard";
export default {
  components: {
    VideoThumbnailCard
  },
  data: () => ({
    videos: [
      ...
      {
        id: "3",
        sourceId: "cGXuAlndfjM",
        title: "Deepika Padukone Gets Ready for the Met Gala | Vogue",
        views: "13.7M",
        likes: "194k"
      },
      {
        id: "4",
        sourceId: "TmtQIs4WAB8",
        title:
